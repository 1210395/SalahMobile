...
<head><meta charset="utf-8"><title>سكن برو</title></head>
<body style="margin:0;padding:24px;background:#F4F6FA;font-family:Tahoma,Arial,sans-serif;color:#1B2233;">
  <div style="max-width:480px;margin:0 auto;background:#FFFFFF;border-radius:16px;padding:28px;">
    <div style="font-size:22px;font-weight:bold;color:#7E42B4;">سكن برو</div>
    ...
    <div style="font-size:34px;font-weight:bold;letter-spacing:8px;color:#7E42B4;background:#F4F6FA;
    ...
    <p style="font-size:13px;color:#6B7280;line-height:1.9;">
      ...
      لا تُشارك هذا الرمز مع أي شخص — فريق سكن برو لن يطلبه منك أبداً.
    </p>
    <p style="font-size:13px;color:#6B7280;line-height:1.9;">
